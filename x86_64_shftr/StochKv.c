...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "area");
 	...
 	ivoc_help("help ?1 StochKv /global/cscratch1/sd/zladd/DL4neurons2/modfiles/StochKv.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/global/cscratch1/sd/zladd/DL4neurons2/modfiles/StochKv.mod";
static const char* nmodl_file_text = 
  "TITLE skm95.mod  \n"
  " \n"
  "COMMENT\n"
