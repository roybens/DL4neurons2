...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kv /global/cscratch1/sd/zladd/DL4neurons2/modfiles/kv.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/global/cscratch1/sd/zladd/DL4neurons2/modfiles/kv.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "kv.mod\n"
  "\n"
