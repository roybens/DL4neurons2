...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca /global/u2/r/roybens/DL4neurons2/modfiles/kca.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/global/u2/r/roybens/DL4neurons2/modfiles/kca.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "kca.mod\n"
  "\n"
